...
public class BenevolentTest {
	...
	public void before() {
		...
		coun1.getPlayer().setStrategy(new Benevolent());
	}
	 ...
	 */
	@Test
	public void testSortAndGetWeakestCoun()
	{
		Benevolent ob = new Benevolent();
		List<Country> t = new ArrayList<>();
		t.add(coun1);
		t.add(coun2);
		assertEquals(ob.sortAndGetWeakestCoun((ArrayList<Country>) listOfCountries), t);
	}
